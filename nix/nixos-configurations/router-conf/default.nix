    ...
    }:
    {
      ...
      config = {
        ...
        services.udev.extraRules = ''
          ...
          SUBSYSTEM=="net", ACTION=="add", KERNELS=="0000:03:00.0", NAME="toborder0F0"
          SUBSYSTEM=="net", ACTION=="add", KERNELS=="0000:03:00.1", NAME="toexpo0F1"
          ...
          SUBSYSTEM=="net", ACTION=="add", KERNELS=="0000:0d:00.0", NAME="TRconfidfC0"
