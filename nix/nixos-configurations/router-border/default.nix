    ...
    }:
    {
      ...
      config = {
        ...
        services.udev.extraRules = ''
          ...
          SUBSYSTEM=="net", ACTION=="add", KERNELS=="0000:03:00.0", NAME="toconfF0"
          SUBSYSTEM=="net", ACTION=="add", KERNELS=="0000:03:00.1", NAME="toexpoF1"
          ...
          SUBSYSTEM=="net", ACTION=="add", KERNELS=="0000:0d:00.0", NAME="internetC0"
