...
in
{
  ...
  testScript =
    ...
    ''
      ...
      coreconf.wait_until_succeeds("kea-dhcp4 -X -t /etc/kea/dhcp4-server.conf", timeout=10)
      coreconf.wait_until_succeeds("kea-dhcp6 -X -t /etc/kea/dhcp6-server.conf", timeout=10)
